       ...
       <div className="row">
         <div className="bg-gradient col-12 col-md-6 bsb-tpl-bg-platinum">
           <div className="d-flex flex-column justify-content-between h-100 p-3 p-md-4 p-xl-5">
             <img className="img-fluid rounded mx-auto my-4" loading="lazy" src="./images/loginlogo.png" width="245" height="80" alt="BootstrapBrain Logo"/>
             <hr class="border-primary-subtle mb-4"/>
            <h2 class="h1 mb-4">Discover Ideal Accommodations Quickly and Conveniently.</h2>
            <p class="lead mb-5">We support you in searching and posting according to your requirements.</p>
            <div class="text-endx">
           ...
           <div className="p-3 p-md-4 p-xl-5">
             ...
             <form action="#!">
               <div className="row gy-3 gy-md-4 overflow-hidden">
                 <div className="col-12">
                   <label for="phonenumber" className="form-label">Số điện thoại <span className="text-danger">*</span></label>
                   <input type="text" className="form-control" name="phonenumber" id="phonenumber" required/>
                 </div>
                 <div className="col-12">
                   <label for="password" className="form-label">Mật khẩu <span className="text-danger">*</span></label>
             ...
             <div className="row">
               <div className="col-12">
                 <p className="mb-4">Hoặc đăng nhập với</p>
