            ...
            <div className='row'>
                <div className='col-sm-8 border border-1 p-2'>
                    ...
                    <div>
                        <h4 className='mt-2 text-danger fw-bold'>
                            ...
                            <FontAwesomeIcon
                                ...
                                className='iconstar'
                            />
                            Phòng VIP quận 1, gần công viên Lê Văn Tám, full nội
                            thất
                        </h4>
                    </div>
                    <div>
                        <p>
                            ...
                            />
                            Dịa chỉ: 32/4 Lý Văn Phức, Phường Tân Định, Quận 1,
                            Hồ Chí Minh
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className='lh-lg'>
                            Còn 2 phòng trống có ban công, cửa sổ lớn, cần cho
                            thuê, rộng rãi đầy đủ tiện nghi, khu an ninh, yên
                            tĩnh: - Máy giặt, sân phơi thoáng mát.
                            <br />
                            - Tủ lạnh
                            <br />
                            - Giường nệm
                            ...
                            <br />
                            Hẻm xe hơi vào thoải mái, ngõ thông ra phố đi bộ Bùi
                            Viện cách 100m, cách chợ Bến Thành 500m.
                            <br />
                            LH: 0913245981 ( chú An ) - Nhà cam kết đúng như
                            hình chụp.
                        </p>
                    </div>
                    <div className='container'>
                        <h4>Bản đồ</h4>
                        <p>
                            Dịa chỉ: 01 Võ Văn Ngân, Linh Chiểu, Thủ Đức, Thành
                ...
                <div className='col-sm-4'>
                    ...
                    <div className='border border-1 rounded mt-2'>
                        ...
                        >
                            <a
                                href='#'
                                className='row g-0 text-decoration-none'
                            >
